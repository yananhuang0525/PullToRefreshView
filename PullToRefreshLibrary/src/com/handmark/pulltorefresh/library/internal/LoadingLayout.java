...
public abstract class LoadingLayout extends LinearLayout {
    ...
    private final LinearLayout layout_time;
    ...
    public LoadingLayout(Context context, final Mode mode, final int scrollDirection, TypedArray attrs) {
        ...
        mHeaderTime = (TextView) findViewById(R.id.pull_to_refresh_time);
        SimpleDateFormat format = new SimpleDateFormat("yyyy年MM月dd日  HH:mm");
        String date = format.format(new Date());
        mHeaderTime.setText(date);

        switch (mode) {
            case PULL_FROM_END:
                // Load in labels
                mPullLabel = context.getString(R.string.pull_to_bottom_pull_label1);
                mRefreshingLabel = context.getString(R.string.pull_to_bottom_refreshing_label1);
                mReleaseLabel = context.getString(R.string.pull_to_bottom_release_label1);
